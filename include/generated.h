...
#define WHICH_LBUTTON 1
#define WHICH_RBUTTON 2
#define WHICH_CANCEL 3
#define WHICH_MBUTTON 4
#define WHICH_XBUTTON1 5
#define WHICH_XBUTTON2 6
#define WHICH_BACK 8
